<template>
  <div class="g-userWrap">
    ...
    <v-pop-box id="organize" v-dialogDrag v-if="isShowBox" v-on:save="saveFn" v-on:cancle="cancleFn" v-bind:popData="popData" v-on:getBtnFn="getBtnsFn" v-on:delDept="delDeptFn" v-bind:formData="editDate" v-bind:returnDeptsIds="returnDeptsIds"></v-pop-box>
    <!--获取人员-->
