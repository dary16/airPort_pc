...
L.widget.bindClass(L.widget.BaseWidget.extend({
    ...
    options: {
        resources: [
          ' http://180.76.109.63/leaflet/lib/leafletPlugins/controls/overviewmap/Control.MiniMap.css',
          'http://180.76.109.63/leaflet/lib/leafletPlugins/controls/overviewmap/Control.MiniMap.js',
        ],
    },
    miniMap:null,
    //初始化[仅执行1次]
    create: function () {
        ...
        layerBase = L.mars.layer.cloneLayer(layerBase);
        ...
        this.map.on('baselayerchange', function (e) {
            ...
            var layer = L.mars.layer.cloneLayer(e.layer); 
