      ...
      <div class="blueContent">
        <div class="left">
          ...
          <div class="noticeRadio">
            <el-radio-group v-model="notice.alermType">
        ...
        <div class="subContent clearfix">
          <div class="right">
            <div class="title">
              <label>告警标题：</label>
              <el-input v-model="notice.alermTitle" placeholder="请输入标题"></el-input>
            </div>
            <div>
              <el-input type="textarea" :rows="7" placeholder="请输入内容" v-model="notice.alermComment">
              </el-input>
            </div>
            <div class="status noticeRadio">
              <label for="">状态：</label>
              <el-radio-group v-model="notice.alermStatus">
                <el-radio label="已处理">已处理</el-radio>
                <el-radio label="未处理">未处理</el-radio>
              </el-radio-group>
            </div>
            <!-- <div class="level noticeRadio">
              <label for="">级别：</label>
              <el-radio-group v-model="notice.alermLevel">
  ...
  export default {
    ...
    methods: {
      ...
      onSubmit() {
        ...
        this.notice.orgId = str;
        if(!this.notice.alermComment) {
          this.message.error('请输入告警内容！');
          return false;
        }
        if(!this.notice.alermTitle) {
          this.message.error('请输入告警标题！');
          return false;
        }
        if(!this.notice.orgId) {
          this.message.error('请选择接受告警部门！');
          return false;
        }
