    ...
    <div class="popContent">
      ...
      <div class="blueContent">
        <div class="left">
          <span>选择接收人员</span>
          <div id="noticeTree">
            <el-tree :data="treeData" node-key="id" :show-checkbox="isShowCheckbox" @check="checkedFn" @node-click="handleNodeClick" :props="defaultProps" :default-expanded-keys="spreadArr"></el-tree>
          </div>
          <div class="noticeRadio">
            <el-radio-group v-model="notice.noticeType" @change="setChangeFn">
        ...
        <div class="subContent clearfix">
          <div class="right">
            ...
            <div class="upload">
              <el-upload class="upload-demo" :action="uploadUrl" :on-remove="removeItem" :on-success="successFileFn" :before-upload="beforeFileUpload" :show-file-list="true" mulitple :limit="10">
  ...
  export default {
    ...
    methods: {
      ...
      onSubmit() {
        ...
        if(this.notice.noticeType == "通知" && !this.notice.deptsId) {
      ...
      successFileFn(file) {
        ...
        if(this.urlArr.length == 0) {
          this.urlArr.push(file.body.common);
          this.urlArr.push(file.body.url);
          this.notice.noticeFile = this.urlArr.join('$');
          this.allArr.push(this.notice.noticeFile);
        } else {
          var urlNow = [];
          var nameStr = '';
          urlNow.push(file.body.common);
          urlNow.push(file.body.url);
          nameStr = urlNow.join('$');
          this.allArr.push(nameStr);
          this.notice.noticeFile = this.allArr.join(',');
        }
      ...
      removeItem(item) {
        var removeUrl = item.response.body.url;
